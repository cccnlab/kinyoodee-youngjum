...
function SSInstruction() {
  ...
  function examplePopCircleButton(
    popTime = flashDuration,
  ...
  function instructionAnimation() {
    ...
    timeoutList.push(
      setTimeout(function () {
        ...
        exampleSeq.length * flashInterval +
        cueAndClickIntervalTime)
    );
  ...
  function instructionPopCircleButton(
    popTime = flashDuration,
    intervalTime = flashInterval
  ) {
    isTest = true;
  ...
  const checkSeq = (event) => {
    ...
    if (currAns.length === thisSeq.length) {
      ...
      const equalCheck = (currAns, currSeq) =>
        currAns.length === currSeq.length &&
        currAns.every((value, index) => value === currSeq[index]);
      isTest = false;
          ...
          <div className="tutorial">
            <div
              className={
                ...
                (tutorialStep === 8 ? "" : " onHide")
              }
            >
              <img
                src={instructionProgressbar}
                alt="progressbar"
            ...
            >
              ...
              >
                <div className="container">
                  ...
                  <img
                    ...
                    alt="a pointing hand"
                    className={
                      "pointingHand" + (tutorialStep === 2 ? "" : " onHide")
                    }
                  ></img>
                  <div
                    className="signalInstruction"
                    id="goSignalInstruction"
                  ></div>
                  <button
                    ref={inputRef}
                    className="cirButtonInstruction 1"
                    id="cirButton1Instruction"
                  ></button>
                  <button
                    ref={inputRef}
                    className="cirButtonInstruction 2"
                    id="cirButton2Instruction"
                  ></button>
                  <button
                    ref={inputRef}
                    className="cirButtonInstruction 3"
                    id="cirButton3Instruction"
                  ></button>
                  <button
                    ref={inputRef}
                    className="cirButtonInstruction 4"
                    id="cirButton4Instruction"
                  ></button>
                  <button
                    ref={inputRef}
                    className="cirButtonInstruction 5"
                    id="cirButton5Instruction"
                  ></button>
                  <button
                    ref={inputRef}
                    className="cirButtonInstruction 6"
                    id="cirButton6Instruction"
                  ></button>
                </div>
              </div>
              <div className="instructionPerson">
                <img
                  src={instructionPerson}
                  alt="an instruction guy"
                  className={
                    "personStart" +
                    (tutorialStep !== 2 && tutorialStep < 9 ? "" : " onHide")
                  }
                ></img>
                <img
                  src={instructionFinished}
                  alt="an instruction guy"
                  className={
                    "personEnd" + (tutorialStep === 9 ? "" : " onHide")
                  }
                ></img>
              </div>
              <div className="instructionBox">
                <div className="instructionText">
                  {tutorialStep === 1 ? (
                    <p>
                      สวัสดีครับ วันนี้ผมจะมาสอนวิธี <br></br>เล่นเกม{" "}
                      <b>'จำจด กดตาม'</b>
                    </p>
                  ) : null}
                  {tutorialStep === 2 ? (
                    <p>
                      ในเกมนี้ คุณต้อง<br></br>
                      <b>1. จำลำดับของสัญญาณไฟ</b> <br></br>ที่กระพริบบนหน้าจอ{" "}
                      <br></br>
                      <b>2. กดปุ่มตามให้ถูกต้อง</b>
                    </p>
                  ) : null}
                  {tutorialStep === 3 ? (
                    <p>
                      ความเร็วไม่มีผลต่อคะแนนในเกมนี้<br></br>
                      ดังนั้นไม่ต้องรีบกดครับ
                    </p>
                  ) : null}
                  {tutorialStep === 4 ? <p>เรามาลองเล่นกันดูครับ </p> : null}
                  {tutorialStep === 5 && tutorialTest === "wrong" ? (
                    <p>ยังไม่ถูกต้อง ลองดูอีกทีนะครับ</p>
                  ) : null}
                  {tutorialStep === 5 && tutorialTest === "right" ? (
                    <p>
                      ถูกต้องครับ! <br></br>
                      <br></br> คราวนี้จะลองเพิ่มสัญญาณไฟ<br></br>เป็น 3 ครั้ง
                    </p>
                  ) : null}
                  {tutorialStep === 6 ? (
                    <p>
                      ไฟสามารถกระพริบซ้ำปุ่มเดิมได้ <br></br>เพราะฉะนั้น ดูดี ๆ
                      นะครับ
                    </p>
                  ) : null}
                  {tutorialStep === 7 && tutorialTest === "wrong" ? (
                    <p>ยังไม่ถูกต้อง ลองดูอีกทีนะครับ</p>
                  ) : null}
                  {tutorialStep === 7 && tutorialTest === "right" ? (
                    <p>
                      สุดยอด! คุณเรียนรู้ไวมาก <br></br>
                      <br></br>เมื่อคุณเล่นไปเรื่อย ๆ เกมจะเพิ่ม <br></br>
                      จำนวนสัญญาณไฟที่คุณต้องจำ{" "}
                    </p>
                  ) : null}
                  {tutorialStep === 8 ? (
                    <p>
                      ทุกข้อที่คุณตอบ แถบนี้จะเพิ่มขึ้น <br></br>เมื่อแถบนี้เต็ม
                      เกมก็จะจบลง
                    </p>
                  ) : null}
                  {tutorialStep === 9 ? (
                    <p>
                      ยินดีด้วย! คุณได้ผ่านการฝึกเล่น <br></br>เกม{" "}
                      <b>'จำจด กดตาม'</b> แล้ว
                    </p>
                  ) : null}
                </div>
                <div className="instructionControl">
                  <div className="instructionBtnBack">
                    ...
                    tutorialStep === 5 ||
                    tutorialStep === 7 ||
                    tutorialExample === true ? null : (
                      <button
                        disabled={justWait === true}
                        className="backInstruction"
                        onMouseDown={() => {
                          setTutorialStep(tutorialStep - 1);
                        }}
                      >{`< ย้อนกลับ`}</button>
                  ...
                  <div className="instructionBtnNext">
                    ...
                    {tutorialStep < 9 ? (
                      <button
                        ...
                        className={
                          "nextInstruction" +
                          (tutorialTest === "wrong" ? " onHide" : "")
                        }
                        onMouseDown={() => {
                          instructionControl();
                        }}
                      >
                        {tutorialStep === 2 && tutorialExample === false
                          ? `ดูตัวอย่าง >`
                          : null}
                        {tutorialStep === 2 && tutorialExample === true
                          ? `เข้าใจแล้ว >`
                          : null}
                        {tutorialStep !== 2 &&
                        tutorialStep !== 4 &&
